        ...
        <>
            ...
            <section className="courses-section">
                ...
                <div className="course-grid">
                    ...
                    {/* Curso 2 */}
                    <div className="course-card">
                        <img src="https://placehold.co/300x180/E0E0E0/333333?text=Curso+2" alt="Curso de Diseño UX/UI" />
                        <h3>Diseño UX/UI para Principiantes</h3>
                        <p>Domina los fundamentos del diseño centrado en el usuario.</p>
                        <div className="course-meta">
                            <span>★ 4.8</span>
                            <span>(950 alumnos)</span>
                        </div>
                        <button className="btn btn-card">Ver Curso</button>
                    </div>
                </div>
